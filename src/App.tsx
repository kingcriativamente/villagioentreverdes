    ...
    <div className="font-sans bg-[#F9F6F0] text-gray-800 antialiased selection:bg-[#A64322] selection:text-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-10">
            {['O Villagio', 'O Empreendimento', 'Comodidades', 'Galeria', 'Planta 115m²', 'Localização'].map((item) => (
              <a
                key={item}
                href={`#${item.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/\s+/g, '-')}`}
                className={`text-sm tracking-wide hover:text-[#A64322] transition-colors duration-300 ${isScrolled ? 'text-gray-600' : 'text-white/90'}`}
              >
                {item}
              </a>
            ))}
          ...
          {/* Mobile Menu Toggle */}
          <button
            className={`md:hidden z-50 focus:outline-none transition-colors duration-300 ${isScrolled || isMobileMenuOpen ? 'text-gray-800' : 'text-white'}`}
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -20 }}
              className="absolute top-0 left-0 w-full h-screen bg-white flex flex-col items-center justify-center space-y-8 pt-20 z-40"
            >
              {['O Villagio', 'O Empreendimento', 'Comodidades', 'Galeria', 'Planta 115m²', 'Localização'].map((item) => (
                <a
                  key={item}
      ...
      <section className="relative h-screen min-h-[800px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto mt-20">
          <motion.div 
            ...
            className="mb-12"
          >
            <span className="font-serif text-3xl md:text-4xl text-white/90 tracking-widest uppercase">Villagio</span>
            <br/>
            <span className="font-sans text-sm md:text-base text-white/70 tracking-[0.4em] uppercase font-light">Entre Verdes</span>
          </motion.div>
          <motion.h1 
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 0.4 }}
            className="text-5xl md:text-7xl lg:text-8xl text-white font-serif font-light mb-8 leading-tight tracking-tight"
          >
            A natureza como<br/><span className="italic">extensão da sua casa</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 0.6 }}
            className="text-xl md:text-2xl text-white/80 font-light mb-16 tracking-widest uppercase"
          >
            Viva a Serenidade
          </motion.p>
          <motion.div
          ...
          >
            <a href="#agende-sua-visita" className="inline-flex items-center justify-center text-center bg-[#A64322] hover:bg-[#8A361A] text-white px-12 py-5 rounded-full text-sm uppercase tracking-[0.2em] transition-all hover:scale-105 shadow-2xl w-full sm:w-auto">
              Agende sua visita
            </a>
            <a href="https://wa.me/5519998836542" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center bg-transparent border border-white/30 hover:bg-white/10 text-white px-12 py-5 rounded-full text-sm uppercase tracking-[0.2em] transition-all hover:scale-105 w-full sm:w-auto">
          ...
          >
            <span className="text-white/50 text-xs uppercase tracking-[0.3em] mb-4">Descubra</span>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 md:gap-24 items-center">
            ...
            <motion.div 
              ...
              viewport={{ once: true, margin: "-100px" }}
              variants={fadeInUp}
              className="lg:col-span-7 order-1 lg:order-2 h-[60vh] md:h-[80vh] overflow-hidden"
            >
              <img 
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 md:gap-24 items-center">
            <motion.div 
              ...
              viewport={{ once: true, margin: "-100px" }}
              variants={fadeInUp}
              className="lg:col-span-7 relative h-[70vh] md:h-[90vh] cursor-pointer group overflow-hidden"
              onClick={() => setSelectedImage("https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80")}
            >
              <img 
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-y-12 gap-x-8">
                <div>
                  <div className="text-4xl md:text-5xl font-serif text-[#A64322] mb-4">20</div>
                  <div className="text-xs uppercase tracking-widest text-gray-500">Casas Exclusivas</div>
                </div>
                <div>
                  <div className="text-4xl md:text-5xl font-serif text-[#A64322] mb-4">115m²</div>
                  <div className="text-xs uppercase tracking-widest text-gray-500">Com quintal privativo</div>
                </div>
                <div>
                  <div className="text-4xl md:text-5xl font-serif text-[#A64322] mb-4">3</div>
                  <div className="text-xs uppercase tracking-widest text-gray-500">Suítes</div>
                </div>
                <div>
                  <div className="text-4xl md:text-5xl font-serif text-[#A64322] mb-4">2</div>
                  <div className="text-xs uppercase tracking-widest text-gray-500">Vagas exclusivas</div>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section id="comodidades" className="py-32 md:py-48 bg-white text-[#2C4C3B]">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            {[
              "Portaria remota e segurança 24 horas",
              "Área de lazer integrada à natureza",
              ...
              <motion.div 
                key={index}
                variants={fadeInUp}
                className="group relative p-10 bg-[#F9F6F0] hover:bg-[#2C4C3B] transition-all duration-500 hover:-translate-y-2 hover:shadow-xl flex items-center justify-center text-center h-48"
              >
                <h3 className="text-xl font-serif text-[#2C4C3B] group-hover:text-white transition-colors duration-500">{item}</h3>
              </motion.div>
            ))}
          </motion.div>
          <motion.p 
            ...
            className="text-center text-sm text-gray-500 mt-12 font-light"
          >
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10">
            ...
            <motion.div 
              ...
              className="md:col-span-12 h-[60vh] md:h-[85vh] cursor-pointer overflow-hidden group relative"
              onClick={() => setSelectedImage("https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80")}
            >
              <img src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80" className="w-full h-full object-cover transition-transform duration-[2s] group-hover:scale-105" alt="Fachada" />
              <div className="absolute inset-0 bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
            ...
            <motion.div 
              ...
              className="md:col-span-6 h-[40vh] md:h-[60vh] cursor-pointer overflow-hidden group relative"
              onClick={() => setSelectedImage("https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80")}
            >
              <img src="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" className="w-full h-full object-cover transition-transform duration-[2s] group-hover:scale-105" alt="Interior" />
              <div className="absolute inset-0 bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
            ...
            <motion.div 
              ...
              className="md:col-span-6 h-[40vh] md:h-[60vh] cursor-pointer overflow-hidden group relative"
              onClick={() => setSelectedImage("https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80")}
            >
              <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" className="w-full h-full object-cover transition-transform duration-[2s] group-hover:scale-105" alt="Área Externa" />
              <div className="absolute inset-0 bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                <ZoomIn className="text-white w-10 h-10" />
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="md:col-span-12 h-[50vh] md:h-[70vh] cursor-pointer overflow-hidden group relative"
              onClick={() => setSelectedImage("https://images.unsplash.com/photo-1584622650111-993a426fbf0a?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80")}
            >
              <img src="https://images.unsplash.com/photo-1584622650111-993a426fbf0a?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80" className="w-full h-full object-cover transition-transform duration-[2s] group-hover:scale-105" alt="Lazer" />
              <div className="absolute inset-0 bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                <ZoomIn className="text-white w-12 h-12" />
              </div>
            </motion.div>
      ...
      {/* Floor Plan Section */}
      <section id="planta-115m²" className="py-32 md:py-48 bg-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 md:gap-24 items-center">
            <motion.div 
              initial="hidden"
              ...
              <div className="grid grid-cols-2 gap-6 mb-16">
                {[
                  ...
                  <div key={index} className="flex items-center text-[#2C4C3B]">
                    <div className="w-1.5 h-1.5 bg-[#A64322] rounded-full mr-3"></div>
                    <span className="font-light">{item}</span>
                  </div>
                ))}
              </div>

              <a href="#agende-sua-visita" className="inline-flex items-center justify-center text-center bg-transparent border border-[#2C4C3B] text-[#2C4C3B] hover:bg-[#2C4C3B] hover:text-white px-10 py-4 rounded-full text-sm uppercase tracking-[0.2em] transition-all">
            ...
            >
              <div className="bg-[#F9F6F0] p-8 flex flex-col items-center justify-center cursor-pointer group" onClick={() => setSelectedImage("https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80")}>
                <h4 className="font-serif text-2xl text-[#2C4C3B] mb-8">Pavimento Inferior</h4>
                <div className="relative w-full aspect-[3/4] overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" alt="Planta Inferior" className="w-full h-full object-cover mix-blend-multiply opacity-80 group-hover:scale-105 transition-transform duration-700" />
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <ZoomIn className="text-[#2C4C3B] w-10 h-10 bg-white/80 rounded-full p-2" />
                  </div>
                </div>
              </div>
              <div className="bg-[#F9F6F0] p-8 flex flex-col items-center justify-center cursor-pointer group" onClick={() => setSelectedImage("https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80")}>
                <h4 className="font-serif text-2xl text-[#2C4C3B] mb-8">Pavimento Superior</h4>
                <div className="relative w-full aspect-[3/4] overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" alt="Planta Superior" className="w-full h-full object-cover mix-blend-multiply opacity-80 group-hover:scale-105 transition-transform duration-700" />
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <ZoomIn className="text-[#2C4C3B] w-10 h-10 bg-white/80 rounded-full p-2" />
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 md:gap-24 items-center">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-8">
                <div className="border-l border-[#A64322] pl-6">
                  <div className="text-3xl font-serif text-[#2C4C3B] mb-2">40 min</div>
                  <div className="text-xs uppercase tracking-widest text-gray-500">de Campinas</div>
                </div>
                <div className="border-l border-[#A64322] pl-6">
                  <div className="text-3xl font-serif text-[#2C4C3B] mb-2">1h20</div>
                  <div className="text-xs uppercase tracking-widest text-gray-500">de São Paulo</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative h-[60vh] w-full overflow-hidden shadow-2xl">
                <img src="https://images.unsplash.com/photo-1449844908441-8829872d2607?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80" alt="Região de Sumaré" className="w-full h-full object-cover hover:scale-105 transition-transform duration-[3s]" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#2C4C3B]/80 to-transparent"></div>
                <div className="absolute bottom-8 left-8">
                  <MapPin className="w-8 h-8 text-white mb-4" />
                  <h3 className="font-serif text-3xl text-white mb-2">Sumaré, SP</h3>
                  <p className="text-white/80 font-light">Região em constante valorização</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <a 
                ...
                className="inline-flex items-center justify-center text-center bg-[#2C4C3B] hover:bg-[#1A2E23] text-white px-12 py-5 rounded-full text-sm uppercase tracking-[0.2em] transition-all hover:scale-105 shadow-xl w-full sm:w-auto"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex items-center justify-center bg-transparent border border-[#2C4C3B] text-[#2C4C3B] hover:bg-[#2C4C3B] hover:text-white px-12 py-5 rounded-full text-sm uppercase tracking-[0.2em] transition-all hover:scale-105 w-full sm:w-auto"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-24">
            <div className="md:col-span-5">
              <div className="font-serif text-3xl font-semibold tracking-widest text-white mb-8">
                VILLAGIO<br/><span className="text-xs font-sans tracking-[0.3em] font-light text-white/70">ENTRE VERDES</span>
              </div>
